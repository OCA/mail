...
class MailThread(models.AbstractModel):
    ...
    def _get_notify_valid_parameters(self):
        res = super()._get_notify_valid_parameters()
        # Add mail_post_defer_notify_author to the list of valid parameters
        # to avoid warnings when using it in the context.
        res.add("mail_post_defer_notify_author")
        return res
