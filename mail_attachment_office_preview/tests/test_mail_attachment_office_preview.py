...
from ..controllers.main import MailAttachmentOfficePreviewController
...
class TestOfficeToPdfController(BaseCommon):
    ...
    def setUpClass(cls):
        ...
        cls.controller = MailAttachmentOfficePreviewController()
    ...
    def test_libreoffice_to_pdf_success(self):
        ...
        with (
            patch(
                "odoo.addons.mail_attachment_office_preview.controllers.main.subprocess.run"
            ) as mock_run,
            patch(
                "odoo.addons.mail_attachment_office_preview.controllers.main.open",
                create=True,
            ) as mock_open,
            patch(
                "odoo.addons.mail_attachment_office_preview.controllers.main.os.path.exists",
                return_value=True,
            ),
        ):
    ...
    def _call_route(self, **over):
        ...
        params.update(over)
        with patch(
            "odoo.addons.mail_attachment_office_preview.controllers.main.request",
            fake_request,
        ):
    ...
    def test_route_libreoffice_unavailable(self):
        ...
        with patch(
            "odoo.addons.mail_attachment_office_preview.controllers.main."
            "MailAttachmentOfficePreviewController._get_pdf_cached",
            return_value=None,
        ):
    ...
    def test_route_success(self):
        ...
        with patch(
            "odoo.addons.mail_attachment_office_preview.controllers.main."
            "MailAttachmentOfficePreviewController._libreoffice_to_pdf",
    ...
    def test_office_preview_available_flag(self):
        ...
        with patch(
            "odoo.addons.mail_attachment_office_preview.models.ir_http.shutil.which",
            return_value="/usr/bin/libreoffice",
        ):
            self.assertTrue(IrHttp._mail_attachment_office_preview_available())
        with patch(
            "odoo.addons.mail_attachment_office_preview.models.ir_http.shutil.which",
            return_value=None,
        ):
            self.assertFalse(IrHttp._mail_attachment_office_preview_available())
